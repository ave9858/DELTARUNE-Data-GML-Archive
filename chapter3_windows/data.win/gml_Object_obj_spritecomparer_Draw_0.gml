...
if (sunkus_kb_check_pressed(ord("1")) && keyboard_check(vk_shift)) {
...
if (sunkus_kb_check_pressed(ord("2")) && keyboard_check(vk_shift)) {
...
if (sunkus_kb_check_pressed(ord("3")) && keyboard_check(vk_shift)) {
...
if (sunkus_kb_check(vk_down) && !keyboard_check(vk_shift)) {
	movetimer++;
	go = 0;
...
if (sunkus_kb_check(vk_up) && !keyboard_check(vk_shift)) {
	movetimer++;
	go = 0;
...
if (sunkus_kb_check(vk_left) && !keyboard_check(vk_shift)) {
	movetimer++;
	go = 0;
...
if (sunkus_kb_check(vk_right) && !keyboard_check(vk_shift)) {
	movetimer++;
	go = 0;
...
if (sunkus_kb_check_pressed(vk_numpad9))
	image_index++;

if (sunkus_kb_check_pressed(vk_numpad7))
	image_index--;
