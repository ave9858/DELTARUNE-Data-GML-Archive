if (con == 0 && obj_mainchara.x > 365 && (!sunkus_kb_check_pressed(vk_anykey) && !scr_gamepad_check_any()) && global.interact == 0)
	timer++;
...
if (can_getup && customcon == 1) {
	...
	if (sunkus_kb_check_pressed(vk_anykey) || scr_gamepad_check_any()) {
		con = 20;
		exit;
	}
