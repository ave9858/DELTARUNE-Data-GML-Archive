...
ds_map_set(recruit_sprite_map, 500, 297);
ds_map_set(recruit_sprite_map, 630, 286);
ds_map_set(recruit_sprite_map, 631, 287);
ds_map_set(recruit_sprite_map, 632, 291);
ds_map_set(recruit_sprite_map, 633, 288);
ds_map_set(recruit_sprite_map, 634, 290);
ds_map_set(recruit_sprite_map, 635, 289);
ds_map_set(recruit_sprite_map, 636, 292);
ds_map_set(recruit_sprite_map, 642, 293);
ds_map_set(recruit_sprite_map, 900, 294);
