...
if (con > 0 && type == 2) {
	...
	if (con == 6 && instance_exists(obj_dialoguer) == 0) {
		con = 7;
		alarm[4] = 60;
	}
	...
	if (con == 13 && instance_exists(obj_dialoguer) == 0) {
		with (s) {
			hspeed = -1;
			image_speed = 0.1;
		}
	...
	if (con == 25 && instance_exists(obj_dialoguer) == 0) {
		con = 27;
		alarm[4] = 50;
	}
	...
	if (con == 35 && instance_exists(obj_dialoguer) == 0) {
	...
	if (instance_exists(obj_dialoguer) == 0 && con == 38) {
	...
	if (con == 43 && instance_exists(obj_dialoguer) == 0) {
	...
	if (con == 50 && instance_exists(obj_dialoguer) == 0) {
		with (s) {
			hspeed = 2;
			image_speed = 0.2;
		}
	...
	if (con == 55 && instance_exists(obj_dialoguer) == 0) {
		with (s)
			sprite_index = spr_susiel;
	...
	if (con == 58 && instance_exists(obj_dialoguer) == 0) {
		with (s)
			sprite_index = spr_susier;
	...
	if (con == 59 && instance_exists(obj_dialoguer) == 0) {
		with (s) {
			image_speed = 0.2;
			hspeed = 2;
		}
	...
	if (con == 64 && instance_exists(obj_dialoguer) == 0) {
...
if (type == 3) {
	...
	if (scon == 5 && instance_exists(obj_dialoguer) == 0) {
		with (obj_doorC)
			instance_destroy();
	...
	if (dex == 1 && instance_exists(obj_dialoguer) == 0 && global.interact == 1) {
		dex = 0;
		global.interact = 0;
	}
}
