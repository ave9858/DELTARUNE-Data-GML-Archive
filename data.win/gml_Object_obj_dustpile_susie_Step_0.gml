...
if (con == 14 && instance_exists(obj_dialoguer) == 0) {
	con = 15;
	alarm[4] = 30;
}
...
if (con == 22 && instance_exists(obj_dialoguer) == 0) {
	con = 23;
	alarm[4] = 30;
}
...
if (con == 32 && instance_exists(obj_dialoguer) == 0) {
	y -= 200;
	con = 33;
	global.interact = 0;
	speedtimer = 0;
...
if (con == 34 && instance_exists(obj_dialoguer) == 0) {
	with (partysus)
		visible = false;
