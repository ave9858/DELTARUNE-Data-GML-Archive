...
if (dex == 1 && instance_exists(obj_dialoguer) == 0) {
	global.facing = 1;
	global.interact = 0;
	dex = 0;
}
...
if (con == 2 && instance_exists(obj_dialoguer) == 0) {
	image_speed = 0.2;
	global.interact = 0;
	hspeed = 3;
	con = 3;
...
if (con == 5 && instance_exists(obj_dialoguer) == 0) {
...
if (con == 8 && instance_exists(obj_dialoguer) == 0) {
	sprite_index = spr_susier;
	image_speed = 0.2;
	global.interact = 0;
	hspeed = 3;
...
if (instance_exists(obj_dialoguer) == 0 && con == 70) {
	hspeed = 0;
	__view_set(9, 0, -4);
