...
if (con == 6 && !instance_exists(obj_writer)) {
	appear = instance_create(__view_get(0, 0) + 420, __view_get(1, 0) + 160, obj_rurus_appear);
...
if (con == 20) {
	...
	snd_play(snd_rurus_appear);
	checkerappear = instance_create(__view_get(0, 0) + 380, __view_get(1, 0) + 120, obj_rurus_appear);
