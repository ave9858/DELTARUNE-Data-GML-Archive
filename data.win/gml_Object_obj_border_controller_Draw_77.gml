...
if (global.screen_border_active && border_alpha >= 0) {
	...
	if (room_id == PLACE_CONTACT || room_id == 883 || room_id == PLACE_MENU || room_id == room_gameover || room_id == PLACE_DOG || room_id == ROOM_INITIALIZE || room_id == room_title_placeholder || room_id == room_intro_ch2)
